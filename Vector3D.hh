...
template<typename T>
inline T PointDistance(const Vector2<T>& a, const Vector2<T>& b) {
  return std::sqrt(PointDistanceSqr(a, b)); }

template<typename T>
inline T PointDistance(const Vector3<T>& a, const Vector3<T>& b) {
  return std::sqrt(PointDistanceSqr(a, b)); }
...
template<typename T>
inline Vector2<T> UnitVec(const Vector2<T>& v) {
